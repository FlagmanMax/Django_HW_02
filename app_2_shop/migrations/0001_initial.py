# Generated by Django 4.2.5 on 2024-04-16 17:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_2_shop.client')),
                ('item_id', models.ManyToManyField(to='app_2_shop.item')),
            ],
        ),
    ]
